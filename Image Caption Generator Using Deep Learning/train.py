...
def train(train_loader, encoder, decoder, criterion, encoder_optimizer, decoder_optimizer, epoch):
    ...
    # Batches
    for i, (imgs, caps, caplens) in enumerate(tqdm(train_loader, position = 0, desc = f'Epoch:{epoch}')):
        ...
        #print(pack_padded_sequence(targets, decode_lengths, batch_first=True))
...
def validate(val_loader, encoder, decoder, criterion):
    ...
    with torch.no_grad():
        ...
        for i, (imgs, caps, caplens, allcaps) in enumerate(tqdm(val_loader)):
            ...
            # References
            allcaps = allcaps.to(device)[sort_ind]  # because images were sorted in the decoder
